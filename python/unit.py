...
class RV_Unit(RV_Object):
    ...
    @property
    def group(self)->RV_Object:raise NotImplementedError # possibly requires now class for groups

    @group.setter
    def group(self, group:RV_Object):raise NotImplementedError # if group is a group then add to, else add to group of unit.
    ...
    def skill_final(self, sub_skill)->float:raise NotImplementedError
